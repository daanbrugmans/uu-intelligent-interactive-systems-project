...
def test_conversation():
    ...
    scenarios = [
        ("Hey there!", EmotionType.POSITIVE, 8.0, 6.0),
        ("These items look nice", EmotionType.NEUTRAL, 7.0, 5.0),
        ("How much is this?", EmotionType.NEUTRAL, 7.0, 5.0),
        ("I'm not sure about this...", EmotionType.NEGATIVE, 3.0, 3.0),
        ("Thanks, goodbye!", EmotionType.POSITIVE, 8.5, 5.5),
    ]
    ...
    for i, (user_input, emotion_type, valence, arousal) in enumerate(scenarios, 1):
        ...
        result = graph.invoke(
            {"state": session, "emotion": emotion, "continue_conversation": True}
        )
